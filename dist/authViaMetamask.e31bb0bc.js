...
var isMetamask = function isMetamask() {
  var _window = window,
      ethereum = _window.ethereum;
  return Boolean(ethereum && ethereum.isMetaMask);
};

var installMetamask = function installMetamask() {
...
var metamaskCheck = function metamaskCheck() {
  if (!isMetamask()) {
    ...
    connect().then(function (accounts) {
...
//# sourceMappingURL=/authViaMetamask.e31bb0bc.js.map